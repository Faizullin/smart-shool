...
import { IAuthUser, IChangePasswordProps, IStudentData, IUserData } from "../models/IAuthUser";
...
export default class UserService {
    ...
    static async fetchStudentData(): Promise<AxiosResponse<IStudentData>> {
        return $api.get<IStudentData>('/students/me/') //.then(response => response.data)
    }
