import{j as e,ap as t,F as s}from"./index-9951c21b.js";import{P as a,D as i}from"./ProjectLayout-f8ff0662.js";import{d as r}from"./index-f2da4b8a.js";const o=`import serial.tools.list_ports
...
# Customize 
DEVICE_ID = None # Device id from broadcast page
DEVICE_PASSWORD = None # Device password from broadcast page
URL = f'wss://smedufacelearn.kz/ws/projects/broadcast/{DEVICE_ID}/device/?password={DEVICE_PASSWORD}'
DELAY_INTERVAL = 10
...
`,l=()=>e.jsx(a,{children:e.jsx("div",{children:e.jsxs(t,{defaultActiveKey:"0",children:[e.jsxs(t.Item,{eventKey:"0",children:[e.jsx(t.Header,{children:e.jsx(s,{id:"dashboard.instructions_title_0"})}),e.jsx(t.Body,{children:e.jsx("p",{children:e.jsx(s,{id:"dashboard.instructions_body_0"})})})]}),e.jsxs(t.Item,{eventKey:"1",children:[e.jsx(t.Header,{children:e.jsx(s,{id:"dashboard.instructions_title_1"})}),e.jsxs(t.Body,{children:[e.jsx("p",{children:e.jsx(s,{id:"dashboard.instructions_body_1"})}),e.jsx(r,{height:"30vh",defaultLanguage:"python",defaultValue:o,options:{readOnly:!0}})]})]}),e.jsxs(t.Item,{eventKey:"2",children:[e.jsx(t.Header,{children:e.jsx(s,{id:"dashboard.instructions_title_2"})}),e.jsxs(t.Body,{children:[e.jsx("p",{children:e.jsx(s,{id:"dashboard.instructions_body_2"})}),e.jsx(r,{height:"60vh",defaultLanguage:"python",defaultValue:n,options:{readOnly:!0}})]})]}),e.jsxs(t.Item,{eventKey:"3",children:[e.jsx(t.Header,{children:e.jsx(s,{id:"dashboard.instructions_title_3",defaultMessage:"C++ Arduino JSON Data"})}),e.jsxs(t.Body,{children:[e.jsx("p",{children:e.jsx(s,{id:"dashboard.instructions_body_3"})}),e.jsx(r,{height:"40vh",defaultLanguage:"cpp",defaultValue:i,options:{readOnly:!0}})]})]})]})})});export{l as default};
