...
mark_read.short_description = gettext_lazy(
...
class NotificationAdmin(BaseAdmin):
    ...
    readonly_fields = ('action_object_url',
                       'actor_object_url', 'target_object_url',)
    ...
    def get_fieldsets_dict(self, request, obj=None):
        ...
        edit_only_fields = ['action_object_url',
                            'actor_object_url', 'target_object_url', 'timestamp']
        if not obj:
            ...
            default_fieldsets_dict[self.lookup_important_dated_key]["value"]["fields"] = [
                'timestamp']
            return default_fieldsets_dict
